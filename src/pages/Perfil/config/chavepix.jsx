    ...
    return (
        <>
            <section className="privacidade-config">
                <h2>💳 Chave Pix</h2>
                <p>
                    Por favor, coloque sua chave Pix para receber as suas compensações conforme a sua CPP.
                    <br /><br />
                    ⚠️ O nome cadastrado na chave Pix deve ser <strong>exatamente o mesmo nome da sua conta IronGoals</strong>.
                    Caso haja qualquer diferença, o sistema <strong>não poderá liberar o pagamento das suas comissões</strong>.
                </p>
